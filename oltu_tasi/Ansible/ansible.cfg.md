...
;become_plugins=/home/ottoman/.ansible/plugins/become:/usr/share/ansible/plugins/become
...
;collections_path=/home/ottoman/.ansible/collections:/usr/share/ansible/collections
...
;action_plugins=/home/ottoman/.ansible/plugins/action:/usr/share/ansible/plugins/action
...
;cache_plugins=/home/ottoman/.ansible/plugins/cache:/usr/share/ansible/plugins/cache

# (pathspec) Colon separated paths in which Ansible will search for Callback Plugins.
;callback_plugins=/home/ottoman/.ansible/plugins/callback:/usr/share/ansible/plugins/callback

# (pathspec) Colon separated paths in which Ansible will search for Cliconf Plugins.
;cliconf_plugins=/home/ottoman/.ansible/plugins/cliconf:/usr/share/ansible/plugins/cliconf

# (pathspec) Colon separated paths in which Ansible will search for Connection Plugins.
;connection_plugins=/home/ottoman/.ansible/plugins/connection:/usr/share/ansible/plugins/connection
...
;filter_plugins=/home/ottoman/.ansible/plugins/filter:/usr/share/ansible/plugins/filter
...
inventory=inventory ; -->  ansible -i inventory or ansible-playbook -i inventory

# (pathspec) Colon separated paths in which Ansible will search for HttpApi Plugins.
;httpapi_plugins=/home/ottoman/.ansible/plugins/httpapi:/usr/share/ansible/plugins/httpapi
...
;inventory_plugins=/home/ottoman/.ansible/plugins/inventory:/usr/share/ansible/plugins/inventory
...
;local_tmp=/home/ottoman/.ansible/tmp
...
;lookup_plugins=/home/ottoman/.ansible/plugins/lookup:/usr/share/ansible/plugins/lookup
...
;library=/home/ottoman/.ansible/plugins/modules:/usr/share/ansible/plugins/modules

# (pathspec) Colon separated paths in which Ansible will search for Module utils files, which are shared by modules.
;module_utils=/home/ottoman/.ansible/plugins/module_utils:/usr/share/ansible/plugins/module_utils

# (pathspec) Colon separated paths in which Ansible will search for Netconf Plugins.
;netconf_plugins=/home/ottoman/.ansible/plugins/netconf:/usr/share/ansible/plugins/netconf
...
private_key_file= ~/.ssh/id_rsa  ;-->  ansible --key-file ~/.ssh/id_rsa
...
;roles_path=/home/ottoman/.ansible/roles:/usr/share/ansible/roles:/etc/ansible/roles
...
;strategy_plugins=/home/ottoman/.ansible/plugins/strategy:/usr/share/ansible/plugins/strategy
...
;terminal_plugins=/home/ottoman/.ansible/plugins/terminal:/usr/share/ansible/plugins/terminal

# (pathspec) Colon separated paths in which Ansible will search for Jinja2 Test Plugins.
;test_plugins=/home/ottoman/.ansible/plugins/test:/usr/share/ansible/plugins/test
...
;vars_plugins=/home/ottoman/.ansible/plugins/vars:/usr/share/ansible/plugins/vars
...
;doc_fragment_plugins=/home/ottoman/.ansible/plugins/doc_fragments:/usr/share/ansible/plugins/doc_fragments
...
;control_path_dir=/home/ottoman/.ansible/pc
...
;cache_dir=/home/ottoman/.ansible/galaxy_cache
...
;token_path=/home/ottoman/.ansible/galaxy_token
...
> [!NOTE] Not 1:
> Bu yukaridaki ansible.cfg dosyası `ansible-config init --disabled > ansible.cfg` komut ile oluşturulur

### Ansible.cfg Açıklaması:
...
> **Explanation:**
> *Inventory dosyamızın yolunu  gösteriyor* : `inventory=invetory`
> *Komut kullanımı* : `ansible -i inventroy OR ansible-playbook -i inventory`
...
```
> **Explanation:**
> *Uzaktadaki sunucun şifresi istenmesini ayarlar* : `become_ask_pass=True`
> *Komut kullanımı* : `ansible --ask-become-pass OR ansible-playbook --ask-become-pass`   

---


### Kaynaklar:
[ansible.cfg dosyası](https://docs.ansible.com/ansible/latest/installation_guide/intro_configuration.html)